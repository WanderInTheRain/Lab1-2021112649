...
public class TextFileToDirectedGraph {
  ...
  /**
   * Generates a directed graph from the given text input. The text input is expected to contain
   * words separated by spaces or commas. Each pair of consecutive words will be treated as a
